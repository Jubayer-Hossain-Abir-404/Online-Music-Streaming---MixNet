...
<body>
			...
			<nav>
				<form action="year.php" method="Post" >
					<ul>
						...
						<li class="current"><a href="year.php">Year</a></li>
	...
	<table>
		...
		<?php
			...
			echo "<h3>Year:<br/></h3>";
			$query= "select * from audios inner join year where release_year=Year";
			...
			if($a>0){
				while($row=mysqli_fetch_array($r)){
					...
					'.$row['filename'].'</a>'."</td><td>".$row['release_year']."</td></tr>";
